module.exports = async (Discord, interaction, axios, { get_role }) => {
    ...
    .then(async done => {
      ...
      .then(async req => {
        ...
        interaction.channel.send(`ยินดีด้วยกับ ${winner} คน ที่ได้รับ ${(done.data.bet * done.data.profit) - done.data.bet} Token! จาก __${"ระบบ Custom Gambit"}__`)
